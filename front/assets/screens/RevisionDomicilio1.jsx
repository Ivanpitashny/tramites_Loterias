...
const RevisionDomicilio1 = ({ navigation, route }) => {
    ...
    const fetchData = async () => {
        try {
            ...
            if (token !== null) {
                const response = await fetch(`${BASE_URL}/v1/cambioDomicilio/tramite/${tramiteId}`, {
                    method: 'GET',
                    headers: {
                ...
                if (response.ok) {
                    ...
                    const cambioDomicilio = data.cambioDomicilioResponse.cambioDomicilio[0];
                    setNombreCompleto(cambioDomicilio.nuevoDomicilio);
                    setNombreSwitch(cambioDomicilio.nuevoDomicilioEstado);
                    setRegsitroSwitch(cambioDomicilio.direccionEstado);
                    setMotivo(cambioDomicilio.motivo);
                    setRegistro(cambioDomicilio.direccion);
                    setEstado(cambioDomicilio.tramite.estado);
                    setFechaFin(cambioDomicilio.tramite.fechaFin);
                    setFechaInicio(cambioDomicilio.tramite.fechaInicio);
                    setTipo(cambioDomicilio.tramite.tipo);
                    setUsuarioId(cambioDomicilio.tramite.usuarioId);
                    setTramite(cambioDomicilio);
                    setIdtitular(cambioDomicilio.id);
                    setCertificadoConducta(cambioDomicilio.certificadoConducta);
                    setCertificadoConductaEstado(cambioDomicilio.certificadoConductaEstado ? true : false);
                } else {
...
export default RevisionDomicilio1;
